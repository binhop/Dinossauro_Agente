...
class Dino(pygame.sprite.Sprite): 
    ...
    def dead(self):
        ...
        if(self.crouched and self.onground):
            self.rect.x += 30
            self.rect.y -= 30
...
class Screens():
    ...
    def screen_menu(self):
        ...
        pygame.draw.rect(self.screen, COR_CINZA, (botao[0], botao[1], botao[2], botao[3]))

        texto_botao = FONT_MENU_2.render('Jogar', True, COR_PRETO)
